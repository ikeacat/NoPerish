...
class UWState extends State<UpdateWidget> {
  ...
  void doUpdateSequence() async {
    ...
    List<Widget> newBlock = [Text("An error occured.")];
    ...
    } else if (githubReq.statusCode == 403) {
      newBlock = [
        Text(
            "This ip has probably been rate limited by GitHub. You can check it manually if you really want to @ https://github.com/ikeacat/NoPerish/releases.")
      ];
    }
